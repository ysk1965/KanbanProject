...
### 9. Members (`/api/v1/boards/{boardId}/members`)
...
### 11. Milestones (`/api/v1/boards/{boardId}/milestones`)
...
### 12. Schedule (`/api/v1/boards/{boardId}/schedule`)
...
### 13. Activity Log (`/api/v1/boards/{boardId}/activities`)
...
### 14. Subscription (`/api/v1/boards/{boardId}/subscription`)
