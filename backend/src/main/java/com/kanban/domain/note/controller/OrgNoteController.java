...
public class OrgNoteController {
    ...
    public ResponseEntity<List<NoteResponse.SearchResult>> searchNotes(
            ...
            @AuthenticationPrincipal UserPrincipal principal) {
        return ResponseEntity.ok(orgNoteService.searchNotes(orgId, principal.getUserId(), q));
    }
    ...
    public ResponseEntity<NoteResponse.Detail> updateStatus(
        ...
        return ResponseEntity.ok(orgNoteService.updateStatus(
                orgId, noteId, principal.getUserId(), request != null ? request.getStatus() : null));
    }
    ...
    public ResponseEntity<NoteResponse.VersionInfo> updateVersionNote(
        ...
        return ResponseEntity.ok(orgNoteService.updateVersionNote(
                orgId, noteId, versionId, principal.getUserId(), request.getNote()));
    }
