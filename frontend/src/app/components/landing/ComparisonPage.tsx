...
export const ComparisonPage: React.FC = () => {
  ...
  const competitorStatus: Record<
    string,
    Record<CompetitorKey, "yes" | "paid" | "no">
  > = {
  ...
  const StatusIcon = ({ status }: { status: "yes" | "paid" | "no" }) => {
    if (status === "yes")
      return <Check size={18} className="text-bridge-secondary" />;
    if (status === "paid")
      return (
    ...
    <div className="min-h-screen bg-bridge-dark text-slate-200 selection:bg-bridge-accent selection:text-white font-inter overflow-x-hidden">
      ...
      <header className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-32 pb-20">
        ...
        <div className="relative z-10 container mx-auto px-8 text-center">
          ...
          >
            <span className="text-white">{t("compare.hero.titleLine1")}</span>
            <br />
          ...
          >
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.4em] font-jakarta">
              {t("compare.hero.scroll")}
            </span>
          </motion.div>
        </div>
      </header>
      ...
      <main>
        ...
        <section
          id="features"
          className="py-32 md:py-48 bg-bridge-obsidian/40 border-y border-white/15 relative overflow-hidden"
        >
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-5xl mb-20 md:mb-32">
              <div className="inline-block mb-8 text-[11px] font-bold tracking-[0.6em] text-bridge-secondary uppercase font-jakarta">
                {t("compare.features.label")}
              </div>
              <h2 className="font-jakarta text-4xl md:text-7xl lg:text-8xl mb-8 leading-none text-white tracking-tighter font-extrabold">
                {t("compare.features.titleLine1")}
                <br />
                {t("compare.features.titleLine2")}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-bridge-obsidian/60 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] border border-white/10 overflow-hidden">
                {/* Table Header */}
                <div className="grid grid-cols-3 gap-2 sm:gap-4 p-4 sm:p-6 md:p-8 border-b border-white/10">
                  <div className="text-[11px] font-bold tracking-[0.4em] text-slate-500 uppercase font-jakarta">
                    {t("compare.features.feature")}
                  </div>
                  <div className="text-center">
                    <span className="text-[11px] font-bold tracking-[0.3em] text-bridge-secondary uppercase font-jakarta">
                      Bridge
                    </span>
                  </div>
                  <div className="text-center">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        {
                          competitors.find((c) => c.key === selectedCompetitor)
                            ?.label
                        }
                      </motion.span>
                    </AnimatePresence>
                ...
                {features.map((feature, i) => (
                  <motion.div
                    ...
                    className={`grid grid-cols-3 gap-2 sm:gap-4 p-4 sm:p-6 md:p-8 items-center group hover:bg-white/5 transition-all ${
                  ...
                  >
                    <div className="flex items-center gap-3 md:gap-4">
                      <feature.icon
                        size={18}
                        className="text-bridge-accent flex-shrink-0 hidden md:block"
                      />
                      <span className="text-sm md:text-base text-white font-medium font-jakarta">
                        {t(`compare.features.items.${feature.key}.name`)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-center">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          <StatusIcon
                            status={
                              competitorStatus[feature.key][selectedCompetitor]
                            }
                          />
                        </motion.div>
                      </AnimatePresence>
              ...
              {/* Legend */}
              <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mt-8 text-[11px] font-bold tracking-wider uppercase font-jakarta">
                <div className="flex items-center gap-2">
                  <Check size={14} className="text-bridge-secondary" />
                  <span className="text-slate-500">
                    {t("compare.features.legend.included")}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-amber-400">Paid</span>
                  <span className="text-slate-500">
                    {t("compare.features.legend.paid")}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <Minus size={14} className="text-slate-600" />
                  <span className="text-slate-500">
                    {t("compare.features.legend.none")}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto text-center mb-20 md:mb-32">
              <h2 className="font-jakarta text-4xl md:text-7xl mb-8 text-white tracking-tighter font-extrabold">
                {t("compare.differentiators.title")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto">
              {[
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-8 border transition-all duration-700 ${
                      item.highlight
                        ? "bg-bridge-accent text-white border-bridge-accent shadow-xl"
        ...
        <section
          id="pricing"
          className="py-32 md:py-48 bg-bridge-obsidian border-y border-white/15 relative overflow-hidden"
        >
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-bridge-dark/60 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] border border-white/10 p-8 md:p-12 mb-12">
                <div className="flex items-center justify-between mb-10">
                  ...
                  <span className="text-[11px] font-bold text-slate-500 tracking-widest uppercase font-jakarta">
                    {t("compare.pricing.teamSize")}
                  </span>
                </div>
                  ...
                  {pricingData.map((item, i) => (
                    ...
                    >
                      <div className="flex justify-between items-end">
                        <div>
                          <span
                            className={`text-sm md:text-base font-bold ${item.highlight ? "text-bridge-secondary" : "text-slate-300"}`}
                          >
                            {item.name}
                          </span>
                          <span className="text-[11px] text-slate-500 ml-3">
                            ${item.perUser}/{t("compare.pricing.perUser")}
                          </span>
                        </div>
                        <span
                          className={`text-sm font-mono ${item.highlight ? "text-white font-bold" : "text-slate-400"}`}
                        >
                          ${item.annual.toLocaleString()}/
                          {t("compare.pricing.year")}
                        </span>
                      </div>
                      <div className="h-4 bg-white/5 rounded-full overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          whileInView={{
                            width: `${(item.annual / maxAnnual) * 100}%`,
                          }}
                          viewport={{ once: true }}
                          transition={{
                            duration: 1.5,
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="font-jakarta font-bold text-xl md:text-2xl text-white tracking-tight">
                    {t("compare.pricing.includedTitle")}
                  </h3>
                  <span className="px-4 py-1.5 bg-bridge-secondary/10 border border-bridge-secondary/30 rounded-full text-[10px] font-black text-bridge-secondary tracking-widest uppercase font-jakarta">
                    $5/{t("compare.pricing.perUser")}
                  </span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <Check
                        size={16}
                        className="text-bridge-secondary flex-shrink-0"
                      />
                      <span className="text-sm text-slate-300 font-inter">
                        {t(`compare.pricing.features.${key}`)}
                      </span>
                    </motion.div>
                  ))}
                </div>
        ...
        <section
          id="recommend"
          className="py-32 md:py-48 bg-bridge-dark relative"
        >
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto text-center mb-20 md:mb-32">
              <h2 className="font-jakarta text-4xl md:text-7xl mb-8 text-white tracking-tighter font-extrabold">
                {t("compare.recommend.title")}
                <span className="spot-dot scale-150 ml-4" />
              </h2>
              <p className="text-lg md:text-xl text-slate-400 leading-relaxed font-light font-inter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6 mt-2">
                  ...
                  />
                  <h3 className="font-jakarta font-bold text-2xl text-white tracking-tight">
                    BridgeSpots
                  </h3>
                </div>
                <p className="text-slate-400 font-light mb-8 font-inter">
                  {t("compare.recommend.bridge.desc")}
                </p>
                <ul className="space-y-4">
                  {["useCase1", "useCase2", "useCase3", "useCase4"].map(
                    (key) => (
                      <li key={key} className="flex items-start gap-3">
                        <Check
                          size={18}
                          className="text-bridge-secondary mt-0.5 flex-shrink-0"
                        />
                        <span className="text-sm text-slate-300 font-inter">
                          {t(`compare.recommend.bridge.${key}`)}
                        </span>
                      </li>
                    ),
                  )}
              ...
              >
                <h3 className="font-jakarta font-bold text-2xl text-white tracking-tight mb-6">
                  {t("compare.recommend.others.title")}
                </h3>
                <p className="text-slate-400 font-light mb-8 font-inter">
                  {t("compare.recommend.others.desc")}
                </p>
                <ul className="space-y-4">
                  {["useCase1", "useCase2", "useCase3", "useCase4"].map(
                    (key) => (
                      <li key={key} className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-slate-500 font-inter">
                          {t(`compare.recommend.others.${key}`)}
                        </span>
                      </li>
                    ),
                  )}
        ...
        <section className="py-48 md:py-64 relative overflow-hidden bg-bridge-obsidian border-t border-white/15 text-white text-center">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-8">
            ...
            >
              {t("compare.cta.titleLine1")}
              <br />
              <span className="text-outline">
                {t("compare.cta.titleLine2")}
              </span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <Link to="/landing" className="flex items-center gap-3">
              <img
                src="/BridgeSpotsIcon.png"
                alt="BridgeSpots"
                className="w-8 h-8 rounded-lg shadow-[0_0_15px_rgba(99,102,241,0.4)]"
              />
            ...
            <div className="flex items-center gap-8 text-[11px] font-bold tracking-wider uppercase font-jakarta">
              <Link
                to="/landing"
                className="hover:text-bridge-secondary transition-colors"
              >
                {t("compare.footer.landing")}
              </Link>
              <Link
                to="/privacy"
                className="hover:text-bridge-secondary transition-colors"
              >
                {t("compare.footer.privacy")}
              </Link>
              <Link
                to="/terms"
                className="hover:text-bridge-secondary transition-colors"
              >
                {t("compare.footer.terms")}
              </Link>
            </div>
          </div>
