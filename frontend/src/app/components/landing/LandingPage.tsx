...
const HeroScene = lazyWithRetry(
  () => import("./BridgeScene").then((m) => ({ default: m.HeroScene })),
  "HeroScene",
);
import {
  KanbanDiagram,
  ...
  >
    {highlight && (
      <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
        <Activity size={80} className="text-bridge-accent" />
      </div>
    )}
    <div
      className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-10 border transition-all duration-700 ${
        highlight
          ? "bg-bridge-accent text-white border-bridge-accent shadow-xl scale-110"
          : "bg-white/5 text-bridge-secondary border-white/20 shadow-inner"
      }`}
    >
      <Icon size={28} />
    </div>
    ...
    <p className="text-slate-400 text-lg leading-relaxed font-normal font-inter opacity-90">
      {desc}
    </p>
  </motion.div>
);
...
export const LandingPage: React.FC = () => {
  ...
  const [dailyTab, setDailyTab] = useState<"timeblock" | "checklist">(
    "timeblock",
  );
  ...
  return (
    <div className="min-h-screen bg-bridge-dark text-slate-200 selection:bg-bridge-accent selection:text-white font-inter overflow-x-hidden">
      {/* Navigation */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 safe-top ${scrolled ? "glass border-b border-white/15 py-4" : "bg-transparent py-8"}`}
      >
        <div className="container mx-auto px-8 flex justify-between items-center">
          ...
          >
            <img
              ...
              alt="BridgeSpots"
              className="w-10 h-10 rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.6)] group-hover:scale-110 transition-all duration-500"
            />
            <div className="font-jakarta font-bold text-2xl tracking-tighter transition-all duration-500">
              <span className="text-white">Bridge</span>
              <span className="text-bridge-secondary">Spots</span>
              <span className="spot-dot w-1.5 h-1.5 ml-1" />
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-12 text-[11px] font-bold tracking-[0.4em] text-slate-400 uppercase font-jakarta">
            ...
            <a
              href="#myspace"
              onClick={scrollToSection("myspace")}
              className="hover:text-white transition-all duration-300"
            >
            ...
            <Link
              to="/compare"
              className="hover:text-bridge-secondary transition-all duration-300"
            >
            ...
            <button
              ...
              className="px-10 py-3.5 bg-white text-bridge-dark rounded-full hover:bg-bridge-secondary hover:shadow-[0_0_30px_rgba(45,212,191,0.5)] transition-all duration-500 font-extrabold tracking-widest text-[11px]"
            >
      ...
      {menuOpen && (
        ...
        >
          <a
            href="#core"
            onClick={scrollToSection("core")}
            className="uppercase font-bold tracking-[0.25em] text-slate-400"
          >
            {t("landing.nav.features")}
          </a>
          <a
          ...
          <button
            onClick={handleGetStarted}
            className="px-10 py-5 bg-bridge-accent text-white rounded-full shadow-2xl uppercase font-bold tracking-widest text-sm"
          >
      ...
      <header className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <Suspense
          fallback={<div className="absolute inset-0 bg-bridge-dark" />}
        >
          <HeroScene />
        </Suspense>
        ...
        <div className="relative z-10 container mx-auto px-8 text-center">
          ...
          >
            {t("landing.hero.subtitleText1")}{" "}
            <span className="text-bridge-secondary font-semibold">
              {t("landing.hero.subtitleFlow")}
            </span>
            .<br />
          ...
          >
            <button
              onClick={handleGetStarted}
              className="px-16 py-7 bg-bridge-accent text-white rounded-full font-bold uppercase tracking-widest text-[12px] shadow-[0_0_60px_rgba(99,102,241,0.5)] hover:bg-white hover:text-bridge-dark transition-all transform hover:-translate-y-2 duration-500 flex items-center gap-3 mx-auto md:mx-0 font-jakarta"
            >
              {t("landing.hero.tryFree")} <ArrowRight size={20} />
            </button>
            <button
              onClick={handleGetStarted}
              className="px-16 py-7 bg-white/5 border border-white/20 text-white rounded-full font-bold uppercase tracking-widest text-[12px] shadow-xl backdrop-blur-md hover:bg-white/10 transition-all transform hover:-translate-y-1 duration-500 mx-auto md:mx-0 font-jakarta"
            >
      ...
      <main>
        ...
        <section
          id="core"
          className="py-64 bg-bridge-obsidian/40 border-y border-white/15 relative overflow-hidden"
        >
        ...
        <section id="workflow" className="py-48 bg-bridge-dark relative">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto text-center mb-32">
              <h2 className="font-jakarta text-4xl md:text-8xl mb-10 text-white tracking-tighter font-extrabold">
                {t("landing.workflow.title")}
                <span className="spot-dot scale-150 ml-4" />
              </h2>
                ...
                {[
                  {
                    ...
                    text: t("landing.workflow.step1.text"),
                  },
                  {
                    num: "02",
                    title: t("landing.workflow.step2.title"),
                    text: t("landing.workflow.step2.text"),
                  },
                  {
                    num: "03",
                    title: t("landing.workflow.step3.title"),
                    text: t("landing.workflow.step3.text"),
                  },
                ].map((item, i) => (
                  <motion.div
                    whileHover={{ x: 10 }}
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-3xl font-jakarta font-bold text-white mb-4 tracking-tight group-hover:text-bridge-secondary transition-colors duration-500">
                        {item.title}
                      </h4>
                      <p className="text-slate-400 leading-relaxed text-lg font-light font-inter">
                        {item.text}
                      </p>
                    </div>
                  </motion.div>
        ...
        <section
          id="scheduling"
          className="py-48 bg-bridge-obsidian border-y border-white/15"
        >
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-28 items-center">
              <div className="lg:col-span-5">
                <div className="inline-block mb-6 text-[11px] font-bold tracking-[0.4em] text-bridge-secondary uppercase font-jakarta">
                  {t("landing.scheduling.label")}
                </div>
                <h2 className="font-jakarta text-4xl md:text-7xl mb-12 leading-tight text-white font-extrabold tracking-tighter">
                  {t("landing.scheduling.titleLine1")} <br />
                  {t("landing.scheduling.titleLine2")}
                  <span className="spot-dot scale-150 ml-2" />
                </h2>
        ...
        <section
          id="myspace"
          className="py-48 bg-bridge-dark relative overflow-hidden"
        >
          ...
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-28 items-center">
              <div className="lg:col-span-5">
                <div className="inline-block mb-6 text-[11px] font-bold tracking-[0.4em] text-bridge-secondary uppercase font-jakarta">
                  {t("landing.myspace.label")}
                </div>
                <h2 className="font-jakarta text-4xl md:text-7xl mb-12 leading-tight text-white font-extrabold tracking-tighter">
                  {t("landing.myspace.titleLine1")}
                  <br />
                  {t("landing.myspace.titleLine2")}
                  <span className="spot-dot scale-150 ml-2" />
                </h2>
                <p className="text-xl text-slate-400 mb-16 leading-relaxed font-light font-inter">
                ...
                <div className="space-y-12">
                  {[
                    {
                      icon: LayoutGrid,
                      title: t("landing.myspace.matrix.title"),
                      text: t("landing.myspace.matrix.text"),
                    },
                    {
                      icon: Flame,
                      title: t("landing.myspace.habits.title"),
                    ...
                    >
                      <div className="flex-shrink-0 w-14 h-14 rounded-2xl border border-white/20 bg-white/5 flex items-center justify-center group-hover:bg-bridge-secondary group-hover:border-bridge-secondary transition-all duration-700 shadow-2xl">
                        <item.icon
                          size={22}
                          className="text-bridge-secondary group-hover:text-white transition-colors duration-700"
                        />
                      </div>
                      <div>
                        <h4 className="text-xl font-jakarta font-bold text-white mb-2 tracking-tight group-hover:text-bridge-secondary transition-colors duration-500">
                          {item.title}
                        </h4>
                        <p className="text-slate-400 leading-relaxed text-base font-light font-inter">
                          {item.text}
                        </p>
                      </div>
                    </motion.div>
        ...
        <section
          id="collaboration"
          className="py-48 bg-bridge-obsidian border-y border-white/15 relative"
        >
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-28 items-center">
              ...
              <div className="lg:col-span-5 order-1 lg:order-2">
                <div className="flex items-center gap-4 mb-6">
                  <span className="text-[11px] font-bold tracking-[0.4em] text-bridge-secondary uppercase font-jakarta">
                    {t("landing.collaboration.label")}
                  </span>
                  <span className="px-3 py-1 bg-bridge-secondary/10 border border-bridge-secondary/30 rounded-full text-[9px] font-black text-bridge-secondary tracking-widest uppercase font-jakarta">
                    {t("landing.collaboration.premium")}
                  </span>
                </div>
                <h2 className="font-jakarta text-4xl md:text-7xl mb-12 leading-tight text-white font-extrabold tracking-tighter">
                  {t("landing.collaboration.titleLine1")}
                  <br />
                  {t("landing.collaboration.titleLine2")}
                  <span className="spot-dot scale-150 ml-2" />
                </h2>
                <p className="text-xl text-slate-400 mb-16 leading-relaxed font-light font-inter">
                ...
                <div className="space-y-12">
                  {[
                    {
                      icon: Bell,
                      title: t("landing.collaboration.slack.title"),
                      text: t("landing.collaboration.slack.text"),
                    },
                    {
                      icon: AtSign,
                      title: t("landing.collaboration.mention.title"),
                      text: t("landing.collaboration.mention.text"),
                    },
                    {
                      icon: Settings2,
                      title: t("landing.collaboration.granular.title"),
                      text: t("landing.collaboration.granular.text"),
                    },
                  ].map((item, i) => (
                    <motion.div
                      key={i}
                    ...
                    >
                      <div className="flex-shrink-0 w-14 h-14 rounded-2xl border border-white/20 bg-white/5 flex items-center justify-center group-hover:bg-bridge-accent group-hover:border-bridge-accent transition-all duration-700 shadow-2xl">
                        <item.icon
                          size={22}
                          className="text-bridge-accent group-hover:text-white transition-colors duration-700"
                        />
                      </div>
                      <div>
                        <h4 className="text-xl font-jakarta font-bold text-white mb-2 tracking-tight group-hover:text-bridge-secondary transition-colors duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-28 items-center">
              <div className="lg:col-span-5">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="px-3 py-1 bg-bridge-secondary/10 border border-bridge-secondary/30 rounded-full text-[9px] font-black text-bridge-secondary tracking-widest uppercase font-jakarta">
                    {t("landing.ai.premium")}
                  </span>
                </div>
                <h2 className="font-jakarta text-4xl md:text-7xl mb-12 leading-tight text-white font-extrabold tracking-tighter">
                  {t("landing.ai.titleLine1")}
                  <br />
                  {t("landing.ai.titleLine2")}
                  <span className="spot-dot scale-150 ml-2" />
                </h2>
                <p className="text-xl text-slate-400 mb-16 leading-relaxed font-light font-inter">
                ...
                <div className="space-y-12">
                  {[
                    {
                      icon: Sparkles,
                      title: t("landing.ai.narrative.title"),
                      text: t("landing.ai.narrative.text"),
                    },
                    {
                      icon: Clock,
                      title: t("landing.ai.standup.title"),
                      text: t("landing.ai.standup.text"),
                    },
                    {
                      icon: Users,
        ...
        >
          <div className="container mx-auto px-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch">
              {/* Basic - Free */}
              <div className="p-12 bg-white/5 backdrop-blur-xl rounded-[3rem] border border-white/20 flex flex-col items-center text-center hover:bg-white/10 transition-all duration-700">
                ...
                <p className="text-base text-slate-400 mb-12 font-inter">
                  {t("landing.pricing.basic.tagline")}
                </p>
                <ul className="text-sm space-y-6 text-slate-400 mb-16 text-left w-full border-t border-white/15 pt-12 font-light font-inter">
                  ...
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      ...
                      className="text-bridge-secondary/50 shrink-0"
                    />{" "}
                    {t("landing.pricing.basic.feature6")}
                  </li>
                </ul>
              ...
              <div className="p-12 pt-14 pb-14 bg-bridge-obsidian rounded-[3rem] border-2 border-bridge-secondary/60 shadow-[0_0_160px_rgba(45,212,191,0.25),0_0_60px_rgba(45,212,191,0.15)] flex flex-col items-center text-center transform md:scale-[1.07] relative z-20 transition-all duration-700">
                ...
                <ul className="text-sm space-y-6 text-slate-100 mb-16 text-left w-full border-t border-white/20 pt-12 font-medium font-inter">
                  <li className="flex items-center gap-4 text-bridge-secondary font-bold">
              ...
              {/* Organization - $15 */}
              <div className="p-12 bg-bridge-obsidian rounded-[3rem] border-2 border-bridge-accent/40 shadow-[0_0_120px_rgba(99,102,241,0.15)] flex flex-col items-center text-center relative z-10 transition-all duration-700">
                ...
                <p className="text-base text-slate-400 mb-12 font-inter">
                  {t("landing.pricing.organization.tagline")}
                </p>
                ...
                <ul className="text-sm space-y-6 text-slate-100 mb-16 text-left w-full border-t border-bridge-accent/20 pt-12 font-medium font-inter">
                  <li className="flex items-center gap-4 text-bridge-accent font-bold">
                    <CheckCircle size={22} className="shrink-0" />{" "}
                    {t("landing.pricing.organization.feature1")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                    ...
                    />{" "}
                    {t("landing.pricing.organization.feature2")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature3")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature4")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature5")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature6")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature7")}
                  </li>
                  <li className="flex items-center gap-4">
                    <CheckCircle
                      size={22}
                      className="text-bridge-accent shrink-0"
                    />{" "}
                    {t("landing.pricing.organization.feature8")}
                  </li>
                </ul>
                <div className="mt-auto w-full">
                  <button
      ...
      <footer className="bg-bridge-obsidian text-slate-400 py-48 border-t border-white/15">
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-24 mb-32">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-3 mb-12">
                <img
                  src="/BridgeSpotsIcon.png"
                  alt="BridgeSpots"
                  className="w-10 h-10 rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.6)]"
                />
                <div className="font-jakarta font-bold text-3xl tracking-tighter">
                  <span className="text-white">Bridge</span>
                  <span className="text-bridge-secondary">Spots</span>
                  <span className="spot-dot w-2 h-2 ml-1" />
                </div>
              </div>
            ...
            <div>
              <h4 className="font-bold text-white mb-10 text-[11px] uppercase tracking-[0.5em] font-jakarta">
              ...
              <ul className="text-lg space-y-6 font-light font-inter">
                <li>
                  <a
                    href="#"
                    className="hover:text-bridge-secondary transition-all"
                  >
