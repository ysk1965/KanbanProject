...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/30 overflow-y-auto",
      className,
    )}
    {...props}
  />
  ...
  <DialogPortal data-slot="dialog-portal">
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // 모바일 키보드 대응: max-height를 visual viewport 기준으로
