...
import { X, Flag, Calendar as CalendarIcon, Plus, ChevronRight } from 'lucide-react';
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronRight size={14} className={`shrink-0 ${
                      milestone?.id === ms.id ? 'text-bridge-accent' : 'text-zinc-600 group-hover:text-zinc-400'
                    }`} />
                  </div>
