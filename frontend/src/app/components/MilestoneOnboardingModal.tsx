...
export function MilestoneOnboardingModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-bridge-dark text-foreground border-white/10 max-w-xl p-0 gap-0 [&>button:last-child]:hidden overflow-hidden rounded-2xl">
        <DialogTitle className="sr-only">{t('milestone.onboardingTitle')}</DialogTitle>
        {/* 헤더 */}
