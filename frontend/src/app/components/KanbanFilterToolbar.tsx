    ...
    <div className="px-3 md:px-6 py-1.5 md:py-2 border-b border-bridge-border flex items-center gap-2 overflow-x-auto md:overflow-x-visible md:flex-wrap shrink-0 custom-scrollbar">
      ...
      <div className="relative w-52 sm:w-80 shrink-0">
        ...
        <input
          ...
          className="w-full bg-bridge-surface-hover border border-bridge-border rounded-lg py-1.5 pl-10 pr-8 text-xs text-foreground placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-bridge-secondary/40 focus:border-bridge-secondary/40 transition-all"
        />
      ...
      {(filterOptions.keyword ||
        ...
        <>
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-zinc-500 hover:text-foreground transition-colors shrink-0 whitespace-nowrap"
          >
            <X size={12} />
            {t("kanban.reset")}
          </button>
      ...
      {!hideExpandCollapse && (
        <div className="flex items-center gap-1 shrink-0">
          <button
            onClick={onExpandAll}
            className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-zinc-500 hover:text-foreground hover:bg-bridge-surface-hover rounded-lg transition-colors"
